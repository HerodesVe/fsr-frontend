...
import type { AnteproyectoFormData, FormStep, UploadedDocument } from '@/types/anteproyecto.types';
...
export const ResumenExpediente: React.FC<ResumenExpedienteProps> = ({
  formData,
  currentStep,
  steps,
  expedienteId,
  ...
  const documentosObligatorios = [
    ...
    { 
      name: 'Memoria descriptiva de arquitectura', 
      completed: isDocumentCompleted('memoria_descriptiva_arquitectura', formData.memoria_descriptiva_arquitectura) 
    },
    { 
      name: 'Memoria descriptiva de seguridad', 
      completed: isDocumentCompleted('memoria_descriptiva_seguridad', formData.memoria_descriptiva_seguridad) 
    },
    { 
  ...
  // Calcular plazos
  const plazoMinimo = 14;
  const plazoMaximo = 45;
...
export default ResumenExpediente;
