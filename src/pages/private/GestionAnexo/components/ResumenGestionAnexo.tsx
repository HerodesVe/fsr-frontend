...
interface ResumenGestionAnexoProps {
...
export const ResumenGestionAnexo: React.FC<ResumenGestionAnexoProps> = ({
  formData,
  currentStep,
  steps,
  gestionId,
  ...
  const documentosObligatorios = [
    { 
      name: 'Anexo H (Formato)', 
      completed: isDocumentCompleted('anexo_h_formato', formData.anexo_h_formato) 
    },
    { 
      name: 'Contrato Supervisor o Convenio de Visitas', 
      completed: isDocumentCompleted('contrato_supervisor', formData.contrato_supervisor) 
    },
    { 
      name: 'Póliza CAR', 
      completed: isDocumentCompleted('poliza_car', formData.poliza_car) 
    },
    { 
      name: 'Resolución de Licencia de Obra', 
      completed: isDocumentCompleted('resolucion_licencia_obra', formData.resolucion_licencia_obra) 
    },
    { 
      name: 'Cronograma de Visitas', 
      completed: isDocumentCompleted('cronograma_visitas', formData.cronograma_visitas) 
    },
    { 
      name: 'Cronograma de Obra', 
      completed: isDocumentCompleted('cronograma_obra', formData.cronograma_obra) 
    },
    { 
      name: 'Hoja de Trámite (Cargo)', 
      completed: isDocumentCompleted('hoja_tramite_cargo', formData.hoja_tramite_cargo) 
    },
    { 
      name: 'Cargo de Entrega al Administrado', 
      completed: isDocumentCompleted('cargo_entrega_administrado', formData.cargo_entrega_administrado) 
    },
  ];

  // Calcular plazos
  const plazoMinimo = 7;
  const plazoMaximo = 15;
...
export default ResumenGestionAnexo;
