import { LuFileText, LuUser, LuMapPin, LuBuilding, LuCheck, LuClock } from 'react-icons/lu';
import { Button } from '@/components/ui';
import type { ConformidadConVariacionFormData, FormStep, UploadedDocument } from '@/types/conformidad.types';

interface ResumenConformidadConVariacionProps {
...
export default function ResumenConformidadConVariacion({
  formData,
  currentStep,
  steps,
  conformidadId,
  ...
  isSaving,
  uploadedDocuments
}: ResumenConformidadConVariacionProps) {
      ...
      <div className="space-y-4 mb-6">
        ...
        <div className="flex items-start gap-3">
          <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${
            formData.estado_seguimiento === 'conforme' 
              ? 'bg-green-100' 
              : formData.estado_seguimiento === 'improcedente'
              ? 'bg-red-100'
              : 'bg-yellow-100'
          }`}>
            {formData.estado_seguimiento === 'conforme' ? (
