...
export default function ElaboracionSinVariacionList() {
  ...
  const handleCreateNew = () => {
    navigate('/dashboard/elaboracion-conformidad-sin-variacion/create');
  };
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-600 mb-6" style={{ fontFamily: 'Inter, sans-serif' }}>
            Comienza creando una nueva elaboración de conformidad sin variación
          </p>
          <Button
            onClick={handleCreateNew}
            style={{ backgroundColor: 'var(--primary-color)' }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredElaboraciones.map((item: any) => (
            <div 
              ...
              onClick={() => navigate(`/dashboard/elaboracion-conformidad-sin-variacion/${item.id}`)}
            >
