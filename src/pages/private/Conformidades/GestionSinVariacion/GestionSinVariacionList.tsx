...
export default function GestionSinVariacionList() {
  ...
  useEffect(() => {
    setHeader(
      ...
      'Gestiona los trámites de conformidad de obra sin variaciones'
    );
  ...
  const handleCreateNew = () => {
    navigate('/dashboard/gestion-conformidad-sin-variacion/create');
  };
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-600 mb-6" style={{ fontFamily: 'Inter, sans-serif' }}>
            Comienza creando una nueva conformidad de obra sin variación
          </p>
          <Button
            onClick={handleCreateNew}
            style={{ backgroundColor: 'var(--primary-color)' }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredConformidades.map((item: any) => (
            <div 
              ...
              onClick={() => navigate(`/dashboard/gestion-conformidad-sin-variacion/${item.id}`)}
            >
