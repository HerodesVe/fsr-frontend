...
interface StepDocumentosInicialesSinVariacionProps {
  formData: any;
...
// Documentos requeridos para Gestión SIN VARIACIÓN
const DOCUMENTOS_SIN_VARIACION = [
  { key: 'derecho_edificar', label: 'Documento que Acredite el Derecho a Edificar', required: true },
  { key: 'planos_aprobados_licencia', label: 'Copia de los Planos Aprobados de la Licencia', required: true },
...
export default function StepDocumentosInicialesSinVariacion({
  formData,
  errors,
  conformidadId,
  uploadedDocuments,
  ...
  onFileUpload,
  onDownloadDocument
}: StepDocumentosInicialesSinVariacionProps) {
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-1" style={{ fontFamily: 'Inter, sans-serif' }}>
              Cargue cada uno de los documentos solicitados para iniciar el trámite de conformidad de obra sin variación.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <div className="space-y-4">
          {DOCUMENTOS_SIN_VARIACION.map((doc) => (
