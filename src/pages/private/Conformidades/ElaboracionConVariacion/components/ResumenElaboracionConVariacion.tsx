...
import type { ElaboracionConVariacionFormData, FormStep, UploadedDocument } from '@/types/conformidad.types';

interface ResumenElaboracionConVariacionProps {
...
export default function ResumenElaboracionConVariacion({
  formData,
  currentStep,
  steps,
  elaboracionId,
  ...
  isSaving,
  uploadedDocuments
}: ResumenElaboracionConVariacionProps) {
