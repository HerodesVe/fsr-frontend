    ...
    <div className="space-y-6">
      <div className="border border-teal-200 bg-teal-50 rounded-lg p-6">
        ...
        <p className="text-sm text-gray-600 mb-6" style={{ fontFamily: 'Inter, sans-serif' }}>
          Suba los documentos relacionados con la especialidad de estructuras.
        </p>
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 border border-gray-200 rounded-lg">
            ...
            <FileUpload
              ...
              value={formData.est_plano_ubicacion || []}
              onChange={(files) => onInputChange('est_plano_ubicacion', files)}
              accept=".pdf,.dwg,.dxf"
              multiple
              onUpload={onFileUpload}
              documentKey="est_plano_ubicacion"
          ...
          <div className="p-4 border border-gray-200 rounded-lg">
            ...
            <FileUpload
              placeholder="Seleccione archivo"
              value={formData.est_plano_arquitectura || []}
              onChange={(files) => onInputChange('est_plano_arquitectura', files)}
              accept=".pdf,.dwg,.dxf"
              multiple
              onUpload={onFileUpload}
              documentKey="est_plano_arquitectura"
              anteproyectoId={proyectoId}
              uploadedFiles={uploadedDocuments}
            />
          </div>
          ...
          <div className="p-4 border border-gray-200 rounded-lg">
            ...
            <FileUpload
              placeholder="Seleccione archivo"
              value={formData.est_plano_seguridad || []}
              onChange={(files) => onInputChange('est_plano_seguridad', files)}
              accept=".pdf,.dwg,.dxf"
              multiple
              onUpload={onFileUpload}
              documentKey="est_plano_seguridad"
              anteproyectoId={proyectoId}
              uploadedFiles={uploadedDocuments}
            />
          </div>
          ...
          <div className="p-4 border border-gray-200 rounded-lg">
            ...
            <FileUpload
              placeholder="Seleccione archivo"
              value={formData.est_memoria_descriptiva_seguridad || []}
              onChange={(files) => onInputChange('est_memoria_descriptiva_seguridad', files)}
              accept=".pdf,.doc,.docx"
              multiple
              onUpload={onFileUpload}
              documentKey="est_memoria_descriptiva_seguridad"
              anteproyectoId={proyectoId}
              uploadedFiles={uploadedDocuments}
            />
          </div>
          ...
          <div className="p-4 border border-gray-200 rounded-lg">
            ...
            <FileUpload
              placeholder="Seleccione archivo"
              value={formData.est_memoria_descriptiva_arquitectura || []}
              onChange={(files) => onInputChange('est_memoria_descriptiva_arquitectura', files)}
              accept=".pdf,.doc,.docx"
              multiple
              onUpload={onFileUpload}
              documentKey="est_memoria_descriptiva_arquitectura"
              anteproyectoId={proyectoId}
              uploadedFiles={uploadedDocuments}
            />
          </div>
          ...
          <div className="p-4 border border-gray-200 rounded-lg">
            ...
            <FileUpload
              placeholder="Seleccione archivo"
              value={formData.est_memoria_descriptiva_estructura || []}
              onChange={(files) => onInputChange('est_memoria_descriptiva_estructura', files)}
              accept=".pdf,.doc,.docx"
              multiple
              onUpload={onFileUpload}
              documentKey="est_memoria_descriptiva_estructura"
              anteproyectoId={proyectoId}
              uploadedFiles={uploadedDocuments}
            />
          </div>
