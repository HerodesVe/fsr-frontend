...
import { DOCUMENT_KEYS } from '@/services/anteproyectos.service';
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mb-6" style={{ fontFamily: 'Inter, sans-serif' }}>
          Seleccione el tipo de obra y modalidad de aprobación para el anteproyecto
        </p>
      ...
      <div className="border-t border-gray-200 pt-6">
        ...
        <p className="text-sm text-gray-600 mb-6" style={{ fontFamily: 'Inter, sans-serif' }}>
          Active esta opción si el anteproyecto requiere consulta al Ministerio de Vivienda, Construcción y Saneamiento
        </p>
